...
int main()
{
     ...
     for( int y = 0; y < b; y++)
     {
         ...
         if ( y == 4)
         {
          ...
          if(y == 5) {
            ...
            Rand_Mas[x][y] = "Rekina Nmr. 0"+to_string(rand()%99999+10000);
  ...
  cout<< endl;
    ...
    cout <<"Ludzu ievadiet skaitli no 0 - 7, lai izveletos personu" << endl;
    cin >> c;
    ...
    cout << endl;
    cout << endl;
    cout << "Cilveks "<< vardi[c] <<" tika atrasts " << reizes << " reizes " << endl;
